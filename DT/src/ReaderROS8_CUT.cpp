...
void ReaderROS8_CUT::goAnalysis(TString fin, int maxEvent, int runN, int runTrig, bool ttrig, bool n2chambers, int chside) {
...
void ReaderROS8_CUT::fillMap_t0()
{
...
void ReaderROS8_CUT::checkMap_t0()
{
...
void ReaderROS8_CUT::fillMap_ttrig(int runTrig)
{
  char fn[100];
...
void ReaderROS8_CUT::checkMap_ttrig(int runTrig)
{
  ofstream myfile;
  myfile.open ("check2.txt");
...
int ReaderROS8_CUT::readEvent(FILE *infile, HITCollection * hits){
...
void ReaderROS8_CUT::readROS(FILE * infile, unsigned int & wordCount, unsigned int & rosOffset, HITCollection * hits){
...
void ReaderROS8_CUT::readTDCGroup(int finalROSWordCount, unsigned int tdcData, FILE * infile, unsigned int & wordCount, unsigned int rosChID, HITCollection * hits) {
                ...
                if( iter != chmap.end() && typeTDC!=0x6 && typeTDC!=0x7 && typeTDC!=0xF ) //<<<<<< QUA E' GIUSTO??
                {
                    ...
                    if(getSe(iter->second) !=1 ) {
                        ...
                        if(m_chside==0) {
                            ...
                            if( getTube(iter->second)<24 || getTube(iter->second)>37 ) {
                                hits->createHIT(evID,getSe(iter->second),getSL(iter->second),getLay(iter->second),getTube(iter->second),x_wire,y_wire,tdcID,rosChID,chID,convToNs*(float(rawtime/4.)),t0,ttrig);
                            }
                        }
...
void ReaderROS8_CUT::readPU(FILE * infile, unsigned int & wordCount, unsigned int & puOffset){
...
unsigned int ReaderROS8_CUT::readWord(FILE * infile, unsigned int & wordCount){
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
int ReaderROS8_CUT::getTDCid( int ros, int rob, int tdc, int cha ) {
  return ( ( ( ( ( ros * nrob ) + rob ) * ntdc ) + tdc ) * ncha ) + cha;
}

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
int ReaderROS8_CUT::getTubeId( int se, int sl, int lay, int tube ) {
  return (se * 10000 + sl * 1000 + lay * 100 + tube);
}

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
int ReaderROS8_CUT::getTube(int idTube) {
  return (idTube - int(idTube/100.)*100.);
}

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
int ReaderROS8_CUT::getLay(int idTube) {
  return (int(idTube/100.) - int(idTube/1000.)*10);
}

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
int ReaderROS8_CUT::getSL(int idTube) {
  return (int(idTube/1000.) - int(idTube/10000.)*10);
}

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
int ReaderROS8_CUT::getSe(int idTube) {
  return int(idTube/10000.);
}

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
int ReaderROS8_CUT::getSLId( int se, int sl ) {
