...
void histos() {
    ...
    TString filename_pos[7];  filename_pos[0] = "output/Run_4611_DT_pos.root";
                              filename_pos[1] = "output/Run_4612_DT_pos.root";
                              filename_pos[2] = "output/Run_4614_DT_pos.root";
                              filename_pos[3] = "output/Run_4615_DT_pos.root";
                              filename_pos[4] = "output/Run_4616_DT_pos.root";
                              filename_pos[5] = "output/Run_4617_DT_pos.root";
                              filename_pos[6] = "output/Run_4619_DT_pos.root";

    TString filename_neg[7];  filename_neg[0] = "output/Run_4611_DT_neg.root";
                              filename_neg[1] = "output/Run_4612_DT_neg.root";
                              filename_neg[2] = "output/Run_4614_DT_neg.root";
                              filename_neg[3] = "output/Run_4615_DT_neg.root";
                              filename_neg[4] = "output/Run_4616_DT_neg.root";
                              filename_neg[5] = "output/Run_4617_DT_neg.root";
                              filename_neg[6] = "output/Run_4619_DT_neg.root";
    
    ///////////////////////////////// loop on all files ////////////////////////////////////////////////////////////////////////////////////////////////////////////////                          
                              
    for( Int_t ifile=0; ifile<7; ifile++ ) {
        
        TFile *file_pos = new TFile( filename_pos[ifile] );
        TFile *file_neg = new TFile( filename_neg[ifile] );
        
        cout << "Opening file " << filename_pos[ifile] << " and " << filename_neg[ifile] << endl;
...
//             } // end if npt
    ...
    TFile *fileoutput = new TFile( "output/Run_all_DT_histos.root", "RECREATE" );
